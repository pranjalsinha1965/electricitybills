...
#         # Read YAML confgurations files to intialize configurations parameters
...
#         # create and return the Model Trainer Configuration 
#         model_trainer_config = ModelTrainerConfig(
#             root_dir=config.root_dir, 
#             train_data_path=config.train_data_path, 
#             test_data_path = config.test_data_path, 
#             model_name = config.model_trainer, 
#             criterion=params.criterion, 
#             splitter=params.splitter, 
#             min_sample_split=params.min_sample_split, 
#             min_samples_leaf=params.min_samples.leaf, 
#             min_impurity_decrease = params.min_impurity.decrease, 
#             ccp_alpha=params.ccp_aplha, 
#         )
...
#             min_sample_split = self.config.min_sample_split,
...
#         # Logging info 
#         logging.info(f"Model Trainer completed: Saved to {os.pathjoin(self.config.root_dir, self.config.model_name)}")
...
#         data_transformation_config = config.get_data_trasnformation_config()
